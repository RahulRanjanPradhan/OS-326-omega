...
struct file_descriptor
{
  ...
  struct dir *dir;            /* Dir. */
  bool isdir;                 /* Isdir true or false. */
...
// Make judgement about if it is a directory.
static int
...
// Distinguish the file is directory or normal file.
static int
sys_inumber (int handle)
{
  ...
  if (fd->isdir)
  {
    inumber = inode_get_inumber(dir_get_inode(fd->dir));
  }
  else
  {
